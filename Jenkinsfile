        ...
        steps {
          ...
          script {
            step([$class: "RundeckNotifier",
              ...
              jobId: "2a0623ca-8a12-4337-ae31-e430fa619a7c",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
               //    PARAM_2=value2
          ...
          script {
            step([$class: "RundeckNotifier",
              includeRundeckLogs: true,
              jobId: "47aceb2d-6438-4a25-abbc-c59e34a662c8",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
               //    PARAM_2=value2
         ...
         sh 'echo Deploying ambiente homologacao'
          ...
          script {
            step([$class: "RundeckNotifier",
              ...
              //JOB DE BUILD
              jobId: "f39221b6-ae57-4657-9b8d-be6660b1801a",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
               //    PARAM_2=value2
          ...
          script {
            step([$class: "RundeckNotifier",
              includeRundeckLogs: true,
              jobId: "7448fab4-69b4-43ec-8d26-0e36f82fcbfe",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
               //    PARAM_2=value2
        ...
        steps {
          ...
          script {
            step([$class: "RundeckNotifier",
              ...
              //JOB DE BUILD
              jobId: "a015266d-75b3-41ff-abc9-785622c73d69",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
               //    PARAM_2=value2
          ...
          script {
            step([$class: "RundeckNotifier",
              includeRundeckLogs: true,
              jobId: "45bfb706-131d-4d6c-b69f-1a1df101cdd3",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
              //    PARAM_2=value2
